...
<body>
    <div class="split-layout">
        ...
        <div class="left-panel">
            <a href="/" class="brand mb-6" style="display:inline-block;">
                UTP
            </a>
            <div class="login-container">
                ...
                <form method="POST" data-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-input" placeholder="As per IC"
                            required value="<?= htmlspecialchars($old['full_name'] ?? '') ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="phone" name="phone" class="form-input" placeholder="01X-XXXXXXX"
                                required value="<?= htmlspecialchars($old['phone'] ?? '') ?>">
                    ...
                    <div class="form-group" style="margin-bottom:1.5rem;">
                        ...
                        <input type="text" id="ic_number" name="ic_number" class="form-input"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password" class="form-input"
                                data-validate="password" placeholder="Min 8 characters" required
                                autocomplete="new-password">
                            <div class="form-error" id="password_error"></div>
                            <div id="password_strength"
                                style="font-size:0.75rem;margin-top:4px;font-weight:600;color:#6b7280;position:absolute;top:100%;">
                            </div>
                        </div>
                        <div class="form-group">
