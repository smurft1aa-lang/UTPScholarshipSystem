<?php
// source: phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar/conf/config.neon
// source: phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon
// source: E:\UTP Scholarship system\phpstan.neon
// source: array
...
class Container_97b1dbee10 extends _PHPStan_eb82cb2ad\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['0113' => true],
		'phpstan.broker.allowedSubTypesClassReflectionExtension' => ['0114' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['0115' => true, '0270' => true],
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['094', '0107', '0109', '0111', '0113']],
		'PHPStan\Reflection\Annotations\AnnotationsMethodsClassReflectionExtension' => [['094']],
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['095', '0108', '0110', '0111', '0115', '0270']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0213', '0216', '0218', '0231', '0333', '0339']],
		...
		'PHPStan\Collectors\Collector' => [['0389', '0390', '0391', '0392', '0393', '0394', '0395', '0415', '0416']],
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['E:/UTP Scholarship system']);
	}


	public function createService029(): PHPStan\Php\ComposerPhpVersionFactory
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['E:/UTP Scholarship system'], null);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('073'),
			[
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionAttribute.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClass.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClassConstant.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionFunctionAbstract.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionMethod.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionParameter.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionProperty.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\iterable.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ArrayObject.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\WeakReference.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ext-ds.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ImagickPixel.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\PDOStatement.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\date.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\ibm_db2.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\mysqli.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\zip.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\dom.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\spl.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\SplObjectStorage.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\Exception.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\arrayFunctions.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\core.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\typeCheckingFunctions.stub',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\Countable.stub',
			],
			['E:/UTP Scholarship system']
		);
	}
	...
	public function createService060(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_97b1dbee10 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'E:\UTP Scholarship system\.phpstan.cache/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['E:/UTP Scholarship system'],
					'5',
					null,
					[
						'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
						'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionAttribute.php',
						'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\Attribute.php',
						'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionIntersectionType.php',
					],
					[],
					[],
					false
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('E:\UTP Scholarship system\.phpstan.cache/resultCache.php');
	}
	...
	public function createService068(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['E:/UTP Scholarship system'],
			[
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\parametersSchema.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level5.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level4.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level3.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level2.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level1.neon',
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\conf\config.level0.neon',
				'E:\UTP Scholarship system\phpstan.neon',
			],
			null,
			[
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
	...
	public function createService075(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'E:\UTP Scholarship system',
			'E:\UTP Scholarship system\.phpstan.cache',
			[
				'phar://E:\UTP Scholarship system\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon',
				'E:\UTP Scholarship system\phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('E:\UTP Scholarship system');
	}
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0136'), false);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0168'), $this->getService('0169'), true, false);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('E:\UTP Scholarship system');
	}
	...
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0135'), false, false, true);
	}


	public function createService0387(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('0135'), false, false, true);
	}


	public function createService0388(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('0135'), false, false, true);
	}
	...
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('0135'), false, true);
	}


	public function createService0398(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('0135'), false, false, true);
	}


	public function createService0399(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0135'), false, true);
	}


	public function createService0400(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0136'), false, false, true);
	}


	public function createService0401(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0136'), false, false, true);
	}


	public function createService0402(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0136'), false, false, true);
	}


	public function createService0403(): PHPStan\Rules\Comparison\LogicalXorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\LogicalXorConstantConditionRule($this->getService('0135'), false, false, true);
	}


	public function createService0404(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule($this->getService('0135'), false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('0135'), false, true);
	}


	public function createService0409(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0135'), false, true);
	}


	public function createService0410(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0135'), false, true);
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('E:\UTP Scholarship system\.phpstan.cache/cache/PHPStan');
	}


	public function createServiceContainer(): Container_97b1dbee10
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('E:\UTP Scholarship system');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('E:\UTP Scholarship system');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['E:\UTP Scholarship system\src'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => 'E:\UTP Scholarship system\.phpstan.cache/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => 'E:\UTP Scholarship system\.phpstan.cache',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'E:\UTP Scholarship system\.phpstan.cache',
			'rootDir' => 'E:\UTP Scholarship system\vendor\phpstan\phpstan',
			'currentWorkingDirectory' => 'E:\UTP Scholarship system',
			...
			'composerAutoloaderProjectPaths' => ['E:/UTP Scholarship system'],
